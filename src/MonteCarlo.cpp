...
double MonteCarlo::SimulatePrice(const AbstractDerivative& Derivative, unsigned int numberRuns, double rater, double dividend, double spot, double sigma)
{
	...
	{
		double thisGaussian = Random::GetGaussian();
