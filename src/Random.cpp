...
float Random::MoroInverseCumulativeNormal(float x)
{
    ...
    float a [4] = {2.50662823884, -18.61500062529, 41.39119773534, -25.44106049637};
    float b [4] = {-8.47351093090, 23.08336743743, -21.06224101826, 3.13082909833};
    float c [9] = {0.3374754822726147, 0.9761690190917186, 0.1607979714918209, 0.0276438810333863,
