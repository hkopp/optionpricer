...
class BlackScholesFormulas
{
    public:
		...
		//! The gamma of a european call option
		static double GetGamma(double rater, double dividend, double spot, double sigma, const EuropeanCallOption& europeancall);

		//! The gamm of a european put option
		static double GetGamma(double rater, double dividend, double spot, double sigma, const EuropeanPutOption& europeanput);
